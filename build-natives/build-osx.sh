...
build_architecture() {
    ...
    cp bin/ReleaseDLL/libsteamworks4j-$1.dylib ../src/main/resources/libsteamworks4j-$1.dylib
...
lipo -create ../src/main/resources/libsteamworks4j-arm64.dylib ../src/main/resources/libsteamworks4j-x86_64.dylib -output ../src/main/resources/libsteamworks4j.dylib
