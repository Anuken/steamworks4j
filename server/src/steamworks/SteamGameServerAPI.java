...
public class SteamGameServerAPI{
    ...
    public static void loadLibraries() throws SteamException{
        ...
        SteamSharedLibraryLoader.loadLibrary("frogworks-server");
    ...
    public static boolean init(int ip, short gamePort, short queryPort,
        ...
        isRunning = SteamGameServerAPINative.nativeInit(ip, gamePort, queryPort, serverMode.ordinal(), versionString);
