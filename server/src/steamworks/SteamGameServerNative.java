...
class SteamGameServerNative{
	...
	*/
    ...
    static native int getAuthSessionTicket(long pointer, ByteBuffer authTicket,
		...
		ISteamGameServer* server = (ISteamGameServer*) pointer;
		int ticket = server->GetAuthSessionTicket(&authTicket[offset], size, (uint32*) sizeInBytes, nullptr);
		return ticket;
	*/
	...
	*/
    ...
    static native int getPublicIP(long pointer); /*
		ISteamGameServer* server = (ISteamGameServer*) pointer;
		return (jint)server->GetPublicIP().m_unIPv4;
	*/
	...
	*/
    ...
    static native void setAdvertiseServerActive(long pointer, boolean active); /*
		ISteamGameServer* server = (ISteamGameServer*) pointer;
		server->SetAdvertiseServerActive(active);
	*/
