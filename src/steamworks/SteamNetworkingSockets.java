...
public class SteamNetworkingSockets extends SteamInterface{
     ...
     * @throws SteamException If {@code data} is not a direct buffer, or if the incoming message exceeds
     * the buffer's remaining capacity.
     * @implNote The underlying native message is always released before this method returns.
